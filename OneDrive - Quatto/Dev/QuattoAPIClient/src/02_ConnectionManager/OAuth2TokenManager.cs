...
namespace QuattoAPIClient.ConnectionManager
{
    ...
    public class OAuth2TokenManager
    {
        ...
        /// <summary>
        /// Inicializa uma nova instância de <see cref="OAuth2TokenManager"/>.
        /// </summary>
                ...
                using (var client = new HttpClient { Timeout = TimeSpan.FromSeconds(30) })
                {
                    ...
                    using (JsonDocument doc = JsonDocument.Parse(responseBody))
                    {
                        ...
                        if (_enableLogging)
                        {
                            ...
                            string tokenPreview = _cachedToken is null ? "" : _cachedToken.Substring(0, Math.Min(20, _cachedToken.Length));
                            LogInfo($"Token (first 20 chars): {tokenPreview}...");
                        }
                    }
                }
            }
